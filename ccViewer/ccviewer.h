...
protected: //members
	...
	ccGLWindow* m_glWindow_2;		//添加 Chenmobenmo 240919
	ccGLWindow* m_glWindow_3;		//添加 Chenmobenmo 240919
	ccGLWindow* m_glWindow_ALL;		//添加 Chenmobenmo 240920

	ccGLWindow* m_glWindow_copy;	//添加 Chenmobenmo 240921
	ccGLWindow* m_glWindow_2_copy;	//添加 Chenmobenmo 240921
	ccGLWindow* m_glWindow_3_copy;	//添加 Chenmobenmo 240921
...
public://private: //注释 Chenmobenmo 241106
	//! Associated GUI
	Ui::ccViewerClass ui;

private://添加 Chenmobenmo 241002
...
public://添加实例 Chenmobenmo 241106
	static inline ccViewer& Get() { return *ccv; }

private://添加 Chenmobenmo 241106
	static ccViewer* ccv;
};
