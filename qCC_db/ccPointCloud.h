...
public: //other methods
	...
	**/
	...
	void filter(float probability/*删除周围点数百分比*/, float gridLength/*网格大小*/);

	//! Translates cloud
	/** \param T translation vector
	**/
	//标记 Chenmobenmo 240928
	void translate(const CCVector3& T);
	void revolve(int rad, std::string name = "");	//添加 Chenmobenmo 240929
...
public: //添加 Chenmobenmo 240930
	float barycenter_point_x;
	float barycenter_point_y;
	float barycenter_point_z;
	void Get_barycenter_point(int rad = 0, std::string name = "");
